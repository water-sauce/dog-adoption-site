...
function createFilters( dog_arr, arr_name ){
	...
	// flatten array and use reduce function to get the name and number of groupings
	...
	// add the expand button for mobile
...
function createGallery( dogs ){
	...
	let gallery_div = document.getElementById( "image-gallery" ),
		...
		// create empty arrays to be passed to the filter creationx
		breed_arr = [],
		gender_arr = [],
		age_arr = [];
